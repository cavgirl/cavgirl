...
pubcoder.page.title = "12";
pubcoder.page.number = 12;
pubcoder.page.alias = "";
...
var obj4255_onShow_activeActionGroupIndex = -1;
var obj4255_onShow_runningActionsCount = 0;
var obj4255_onShow_loopCount = 0;
var obj5000_onTap_activeActionGroupIndex = -1;
var obj5000_onTap_runningActionsCount = 0;
var obj5000_onTap_loopCount = 0;
var obj6442_SCEventRun_activeActionGroupIndex = -1;
var obj6442_SCEventRun_runningActionsCount = 0;
var obj6442_SCEventRun_loopCount = 0;
...
function show_1968() {
	...
	if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			...
			window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount = window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount - 1;
if (window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount == 0) {
	obj1940_SCEventCounterReachedTargetValue_actionGroup8();
}
			$(element).trigger('SCEventShow');
		}, 1);
		return;
...
obj1940_SCEventCounterReachedTargetValue_actionGroup8 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj1940").trigger("obj1940_SCEventCounterReachedTargetValue_ended");
	...
	window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = 8;
...
function show_1969() {
	...
	if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			...
			window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount = window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount - 1;
if (window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount == 0) {
	obj1940_SCEventCounterReachedTargetValue_actionGroup9();
}
			$(element).trigger('SCEventShow');
		}, 1);
		return;
...
obj1940_SCEventCounterReachedTargetValue_actionGroup9 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj1940").trigger("obj1940_SCEventCounterReachedTargetValue_ended");
	...
	window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = 9;
...
function show_1970() {
	...
	if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			...
			window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount = window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount - 1;
if (window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount == 0) {
	obj1940_SCEventCounterReachedTargetValue_actionGroup10();
}
			$(element).trigger('SCEventShow');
		}, 1);
		return;
...
obj1940_SCEventCounterReachedTargetValue_actionGroup10 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj1940").trigger("obj1940_SCEventCounterReachedTargetValue_ended");
	...
	window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = 10;
...
function wait_5003() {
	...
	setTimeout(function() {
		window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount = window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount - 1;
if (window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount == 0) {
	obj1940_SCEventCounterReachedTargetValue_actionGroup11();
}
	}, 500);
}
...
obj1940_SCEventCounterReachedTargetValue_actionGroup11 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj1940").trigger("obj1940_SCEventCounterReachedTargetValue_ended");
	...
	window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = 11;
...
function show_5004() {
	...
	if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			...
			window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount = window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount - 1;
if (window.obj1940_SCEventCounterReachedTargetValue_runningActionsCount == 0) {
	obj1940_SCEventCounterReachedTargetValue_actionGroup12();
}
			$(element).trigger('SCEventShow');
		}, 1);
		return;
...
obj1940_SCEventCounterReachedTargetValue_actionGroup12 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj1940").trigger("obj1940_SCEventCounterReachedTargetValue_ended");
	...
	window.obj1940_SCEventCounterReachedTargetValue_activeActionGroupIndex = 12;
...
obj4255_onShow_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4255_onShow_activeActionGroupIndex = -1;
		$("#obj4255").trigger("obj4255_onShow_ended");
		
		return;
	}
	window.obj4255_onShow_activeActionGroupIndex = 0;
...
wait_6467();
function wait_6467() {
	window.obj4255_onShow_runningActionsCount = obj4255_onShow_runningActionsCount + 1;
	setTimeout(function() {
		window.obj4255_onShow_runningActionsCount = window.obj4255_onShow_runningActionsCount - 1;
if (window.obj4255_onShow_runningActionsCount == 0) {
	obj4255_onShow_actionGroup1();
}
	}, 1500);
}
...
obj4255_onShow_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj4255_onShow_activeActionGroupIndex = -1;
		$("#obj4255").trigger("obj4255_onShow_ended");
...
obj4255_onShow_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj4255_onShow_activeActionGroupIndex = -1;
		$("#obj4255").trigger("obj4255_onShow_ended");
	...
	window.obj4255_onShow_activeActionGroupIndex = 2;
...
obj5000_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5000_onTap_activeActionGroupIndex = -1;
		$("#obj5000").trigger("obj5000_onTap_ended");
		
		return;
	}
	window.obj5000_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page3
goToPage_5002();
function goToPage_5002() {
	var isPreview = false;
	if (isPreview) {
...
obj5000_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj5000_onTap_activeActionGroupIndex = -1;
		$("#obj5000").trigger("obj5000_onTap_ended");
...
obj6442_SCEventRun_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6442_SCEventRun_activeActionGroupIndex = -1;
		$("#obj6442").trigger("obj6442_SCEventRun_ended");
		
		return;
	}
	window.obj6442_SCEventRun_activeActionGroupIndex = 0;
...
function hide_6444() {
	...
	window.obj6442_SCEventRun_runningActionsCount = obj6442_SCEventRun_runningActionsCount + 1;
	...
	if ($(element).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(element).css("display", "none");
			window.obj6442_SCEventRun_runningActionsCount = window.obj6442_SCEventRun_runningActionsCount - 1;
if (window.obj6442_SCEventRun_runningActionsCount == 0) {
	obj6442_SCEventRun_actionGroup1();
}
		}, 1);
		return;
	};
...
obj6442_SCEventRun_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6442_SCEventRun_activeActionGroupIndex = -1;
		$("#obj6442").trigger("obj6442_SCEventRun_ended");
...
function move_6448() {
	...
	targetObject.animate({ left: moveX+'px', top: moveY+'px'}, 300, easing, function() {
		setTimeout(function() {
			window.obj6442_SCEventRun_runningActionsCount = window.obj6442_SCEventRun_runningActionsCount - 1;
if (window.obj6442_SCEventRun_runningActionsCount == 0) {
	obj6442_SCEventRun_actionGroup2();
}
		}, 1);
	});
}
...
obj6442_SCEventRun_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6442_SCEventRun_activeActionGroupIndex = -1;
		$("#obj6442").trigger("obj6442_SCEventRun_ended");
	...
	window.obj6442_SCEventRun_activeActionGroupIndex = 2;
...
function runjs_6449() {
	...
	setTimeout(function() {
		window.obj6442_SCEventRun_runningActionsCount = window.obj6442_SCEventRun_runningActionsCount - 1;
if (window.obj6442_SCEventRun_runningActionsCount == 0) {
	obj6442_SCEventRun_actionGroup3();
}
	}, 1);
}
//	action: Run JavaScript
...
obj6442_SCEventRun_actionGroup3 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6442_SCEventRun_activeActionGroupIndex = -1;
		$("#obj6442").trigger("obj6442_SCEventRun_ended");
	...
	window.obj6442_SCEventRun_activeActionGroupIndex = 3;
...
function show_6457() {
	...
	if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			...
			window.obj6442_SCEventRun_runningActionsCount = window.obj6442_SCEventRun_runningActionsCount - 1;
if (window.obj6442_SCEventRun_runningActionsCount == 0) {
	obj6442_SCEventRun_actionGroup4();
}
			$(element).trigger('SCEventShow');
		}, 1);
		return;
...
obj6442_SCEventRun_actionGroup4 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj6442_SCEventRun_activeActionGroupIndex = -1;
		$("#obj6442").trigger("obj6442_SCEventRun_ended");
	...
	window.obj6442_SCEventRun_activeActionGroupIndex = 4;
...
//	target: obj6442 
runActionList_6464();
function runActionList_6464() {
	window.obj6461_onTap_runningActionsCount = obj6461_onTap_runningActionsCount + 1;
	$("#obj6442").trigger('SCEventRun');
	setTimeout(function() {
		window.obj6461_onTap_runningActionsCount = window.obj6461_onTap_runningActionsCount - 1;
if (window.obj6461_onTap_runningActionsCount == 0) {
	obj6461_onTap_actionGroup1();
...
$("#obj4255").bind('SCEventShow', function(event) {
	if (window.obj4255_onShow_activeActionGroupIndex != -1) return;
var obj4255_onShow_runningActionsCount = 0;
var obj4255_onShow_loopCount = 0;
obj4255_onShow_actionGroup0();
});
...
/*
 *
 *   obj5000: Event Touch Down
 *
 */
 
$("#obj5000").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj5000_onTap_activeActionGroupIndex != -1) return;
var obj5000_onTap_runningActionsCount = 0;
var obj5000_onTap_loopCount = 0;
obj5000_onTap_actionGroup0();
});
...
/*
 *
 *   obj6442: Event SCEventRun
 *
 */
$("#obj6442").bind("SCEventRun", function(event) {
	if (window.obj6442_SCEventRun_activeActionGroupIndex != -1) return;
var obj6442_SCEventRun_runningActionsCount = 0;
var obj6442_SCEventRun_loopCount = 0;
obj6442_SCEventRun_actionGroup0();
});
...
$("#obj6461").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj6461_onTap_activeActionGroupIndex != -1) return;
var obj6461_onTap_runningActionsCount = 0;
var obj6461_onTap_loopCount = 0;
