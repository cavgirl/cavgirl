...
var obj7508_onDrag_activeActionGroupIndex = -1;
var obj7508_onDrag_runningActionsCount = 0;
var obj7508_onDrag_loopCount = 0;
var obj7508_onTouchDown_activeActionGroupIndex = -1;
var obj7508_onTouchDown_runningActionsCount = 0;
var obj7508_onTouchDown_loopCount = 0;
var obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_activeActionGroupIndex = -1;
var obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_runningActionsCount = 0;
var obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_loopCount = 0;
var obj7667_onLoad_activeActionGroupIndex = -1;
var obj7667_onLoad_runningActionsCount = 0;
var obj7667_onLoad_loopCount = 0;
...
obj7508_onTouchDown_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7508_onTouchDown_activeActionGroupIndex = -1;
		$("#obj7508").trigger("obj7508_onTouchDown_ended");
		
		return;
	}
	window.obj7508_onTouchDown_activeActionGroupIndex = 0;
...
//prevent windows
if (window.SCuaosIsWindows)
	SCPreventTouch("#obj7508");
//	action: dragDrop
//	target: obj7508 
dragDrop_7530();
function dragDrop_7530() {
	event = window.eventObj;
	event.stopPropagation();
	window.obj7508_onTouchDown_runningActionsCount = obj7508_onTouchDown_runningActionsCount + 1;
    ...
    $(this).bind(window.touchUpEvent,function(e){
    	$(this).unbind(window.touchUpEvent + ' ' + window.touchMoveEvent); 
    	window.obj7508_onTouchDown_runningActionsCount = window.obj7508_onTouchDown_runningActionsCount - 1;
if (window.obj7508_onTouchDown_runningActionsCount == 0) {
	obj7508_onTouchDown_actionGroup1();
}
    	//define droppable elements
    	var droppableElements = new Array();
    	var actionsOnDrop = new Array() //for example: "SCActionDragDrop4180_droppedInsideTargetActions","SCActionDragDrop4180_droppedInsideTargetActions2";
    	var dropped_7530 = false;
    	var dropped_id_7530;
    	var eventType;
    	if (window.touchUpEvent == "touchend") {
    		x = e.changedTouches[0].clientX;
		...
		if (droppableElements.length != 0) {
			for (var i = droppableElements.length-1; i >= 0; i--)
			{
				if (isLocationInElementDragDropOffset(droppableElements[i], x, y))
				{
					objectIndex = i;
					dropped_7530 = true;
					dropped_id_7530 = droppableElements[i];
					break;
				}
			}
		} 
		if (dropped_7530) {
			...
			$("#obj7508").trigger('SCActionDragDrop7530_droppedOutsideTargetActions');
		}
    });
}
...
obj7508_onTouchDown_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj7508_onTouchDown_activeActionGroupIndex = -1;
		$("#obj7508").trigger("obj7508_onTouchDown_ended");
...
obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_activeActionGroupIndex = -1;
		$("#obj7508").trigger("obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_ended");
		
		return;
	}
	window.obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_activeActionGroupIndex = 0;
...
function hide_7532() {
	...
	window.obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_runningActionsCount = obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_runningActionsCount + 1;
	...
	if ($(element).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(element).css("display", "none");
			window.obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_runningActionsCount = window.obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_runningActionsCount - 1;
if (window.obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_runningActionsCount == 0) {
	obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_actionGroup1();
}
		}, 1);
		return;
	};
...
obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_activeActionGroupIndex = -1;
		$("#obj7508").trigger("obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_ended");
...
obj7667_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj7667_onLoad_activeActionGroupIndex = -1;
		$("#obj7667").trigger("obj7667_onLoad_ended");
		
		return;
	}
	window.obj7667_onLoad_activeActionGroupIndex = 0;
...
function hide_7687() {
	...
	window.obj7667_onLoad_runningActionsCount = obj7667_onLoad_runningActionsCount + 1;
	...
	if ($(element).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(element).css("display", "none");
			window.obj7667_onLoad_runningActionsCount = window.obj7667_onLoad_runningActionsCount - 1;
if (window.obj7667_onLoad_runningActionsCount == 0) {
	obj7667_onLoad_actionGroup1();
}
		}, 1);
		return;
	};
...
obj7667_onLoad_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj7667_onLoad_activeActionGroupIndex = -1;
		$("#obj7667").trigger("obj7667_onLoad_ended");
...
$("#obj5918").one('SCEventShow', function(event) {
...
$("#obj7508").one(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj7508_onTap_activeActionGroupIndex != -1) return;
var obj7508_onTap_runningActionsCount = 0;
var obj7508_onTap_loopCount = 0;
 ...
 */
 ...
 if (window.SCuaosIsWindows) {
	SCPreventTouch("#obj7508");
	var winTarget = document.getElementById("obj7508");
	winTarget.addEventListener("MSGestureHold", function(e){ e.preventDefault() }, false);
	winTarget.addEventListener("contextmenu", function(e){e.preventDefault()}, false);	
 }
$("#obj7508").bind(window.touchDownEvent, function(event) {
	event.preventDefault();	
	window.eventObj = event; 
	if ((window['obj7508_onTouchUp_activeActionGroupIndex'] != undefined) && window.obj7508_onTouchUp_activeActionGroupIndex != -1) return;
	if (window.obj7508_onTouchDown_activeActionGroupIndex != -1) return;
var obj7508_onTouchDown_runningActionsCount = 0;
var obj7508_onTouchDown_loopCount = 0;
obj7508_onTouchDown_actionGroup0();
});


/*
 *
 *   obj7508: Event SCActionDragDrop7530_droppedOutsideTargetActions
 *
 */
$("#obj7508").bind("SCActionDragDrop7530_droppedOutsideTargetActions", function(event) {
	if (window.obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_activeActionGroupIndex != -1) return;
var obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_runningActionsCount = 0;
var obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_loopCount = 0;
obj7508_SCActionDragDrop7530_droppedOutsideTargetActions_actionGroup0();
});
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj7667_onLoad_activeActionGroupIndex != -1) return;
var obj7667_onLoad_runningActionsCount = 0;
var obj7667_onLoad_loopCount = 0;
obj7667_onLoad_actionGroup0();
});
...
$("#obj7508").trigger('SCEventShow');
$("#obj7667").trigger('SCEventShow');
