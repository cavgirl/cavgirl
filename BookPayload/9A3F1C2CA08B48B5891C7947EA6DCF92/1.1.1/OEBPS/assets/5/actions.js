...
var obj649_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
var obj649_SCEventCounterReachedTargetValue_runningActionsCount = 0;
var obj649_SCEventCounterReachedTargetValue_loopCount = 0;
var obj654_onTap_activeActionGroupIndex = -1;
var obj654_onTap_runningActionsCount = 0;
var obj654_onTap_loopCount = 0;
...
var obj649_counterValue = 0;
var obj649_counterTargetValue = 9;
var obj649_counterCanExceedTargetValue = false;
...
//	target: obj649 
incrementCounter_508();
function incrementCounter_508() {
	window.obj505_onShow_runningActionsCount = obj505_onShow_runningActionsCount + 1;

	var oldValue = obj649_counterValue;
	obj649_counterValue = obj649_counterValue + 1;
	if (! obj649_counterCanExceedTargetValue && obj649_counterValue > obj649_counterTargetValue) {
		obj649_counterValue = obj649_counterTargetValue;
	}
	if (oldValue != obj649_counterValue) {
		$("#obj649").trigger('SCEventCounterValueChange');
		$("#obj649").trigger('SCEventCounterIncrease');
		if (obj649_counterValue == obj649_counterTargetValue)
			$("#obj649").trigger('SCEventCounterReachedTargetValue');
	}
	setTimeout(function() { window.obj505_onShow_runningActionsCount = window.obj505_onShow_runningActionsCount - 1;
...
//	action: increment counter
//	target: obj649 
incrementCounter_512();
function incrementCounter_512() {
	...
	setTimeout(function() { window.obj509_onShow_runningActionsCount = window.obj509_onShow_runningActionsCount - 1;
...
//	action: increment counter
//	target: obj649 
incrementCounter_516();
function incrementCounter_516() {
	...
	setTimeout(function() { window.obj513_onShow_runningActionsCount = window.obj513_onShow_runningActionsCount - 1;
...
//	action: increment counter
//	target: obj649 
incrementCounter_520();
function incrementCounter_520() {
	...
	setTimeout(function() { window.obj517_onShow_runningActionsCount = window.obj517_onShow_runningActionsCount - 1;
...
//	action: increment counter
//	target: obj649 
incrementCounter_524();
function incrementCounter_524() {
	...
	setTimeout(function() { window.obj521_onShow_runningActionsCount = window.obj521_onShow_runningActionsCount - 1;
...
//	action: increment counter
//	target: obj649 
incrementCounter_528();
function incrementCounter_528() {
	...
	setTimeout(function() { window.obj525_onShow_runningActionsCount = window.obj525_onShow_runningActionsCount - 1;
...
//	action: increment counter
//	target: obj649 
incrementCounter_532();
function incrementCounter_532() {
	...
	setTimeout(function() { window.obj529_onShow_runningActionsCount = window.obj529_onShow_runningActionsCount - 1;
...
//	action: increment counter
//	target: obj649 
incrementCounter_536();
function incrementCounter_536() {
	...
	setTimeout(function() { window.obj533_onShow_runningActionsCount = window.obj533_onShow_runningActionsCount - 1;
...
//	action: increment counter
//	target: obj649 
incrementCounter_540();
function incrementCounter_540() {
	...
	setTimeout(function() { window.obj537_onShow_runningActionsCount = window.obj537_onShow_runningActionsCount - 1;
...
obj649_SCEventCounterReachedTargetValue_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj649_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj649").trigger("obj649_SCEventCounterReachedTargetValue_ended");
		
		return;
	}
	window.obj649_SCEventCounterReachedTargetValue_activeActionGroupIndex = 0;
...
noop_651();
function noop_651() {
	window.obj649_SCEventCounterReachedTargetValue_runningActionsCount = obj649_SCEventCounterReachedTargetValue_runningActionsCount + 1;
	setTimeout(function() {
		window.obj649_SCEventCounterReachedTargetValue_runningActionsCount = window.obj649_SCEventCounterReachedTargetValue_runningActionsCount - 1;
if (window.obj649_SCEventCounterReachedTargetValue_runningActionsCount == 0) {
	obj649_SCEventCounterReachedTargetValue_actionGroup1();
}
	}, 1);
}
...
obj649_SCEventCounterReachedTargetValue_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj649_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj649").trigger("obj649_SCEventCounterReachedTargetValue_ended");
...
function wait_652() {
	...
	setTimeout(function() {
		window.obj649_SCEventCounterReachedTargetValue_runningActionsCount = window.obj649_SCEventCounterReachedTargetValue_runningActionsCount - 1;
if (window.obj649_SCEventCounterReachedTargetValue_runningActionsCount == 0) {
	obj649_SCEventCounterReachedTargetValue_actionGroup2();
}
	}, 1000);
}
...
obj649_SCEventCounterReachedTargetValue_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj649_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj649").trigger("obj649_SCEventCounterReachedTargetValue_ended");
	...
	window.obj649_SCEventCounterReachedTargetValue_activeActionGroupIndex = 2;
...
obj649_SCEventCounterReachedTargetValue_actionGroup3 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj649_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj649").trigger("obj649_SCEventCounterReachedTargetValue_ended");
	...
	window.obj649_SCEventCounterReachedTargetValue_activeActionGroupIndex = 3;
...
obj654_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj654_onTap_activeActionGroupIndex = -1;
		$("#obj654").trigger("obj654_onTap_ended");
		
		return;
	}
	window.obj654_onTap_activeActionGroupIndex = 0;
...
wait_657();
function wait_657() {
	window.obj654_onTap_runningActionsCount = obj654_onTap_runningActionsCount + 1;
	setTimeout(function() {
		window.obj654_onTap_runningActionsCount = window.obj654_onTap_runningActionsCount - 1;
if (window.obj654_onTap_runningActionsCount == 0) {
	obj654_onTap_actionGroup1();
}
	}, 500);
}
...
obj654_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj654_onTap_activeActionGroupIndex = -1;
		$("#obj654").trigger("obj654_onTap_ended");
...
obj654_onTap_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj654_onTap_activeActionGroupIndex = -1;
		$("#obj654").trigger("obj654_onTap_ended");
	...
	window.obj654_onTap_activeActionGroupIndex = 2;
...
/*
 *
 *   obj649: Event SCEventCounterReachedTargetValue
 *
 */
$("#obj649").bind("SCEventCounterReachedTargetValue", function(event) {
	if (window.obj649_SCEventCounterReachedTargetValue_activeActionGroupIndex != -1) return;
var obj649_SCEventCounterReachedTargetValue_runningActionsCount = 0;
var obj649_SCEventCounterReachedTargetValue_loopCount = 0;
obj649_SCEventCounterReachedTargetValue_actionGroup0();
});
...
/*
 *
 *   obj654: Event Touch Down
 *
 */
 
$("#obj654").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj654_onTap_activeActionGroupIndex != -1) return;
var obj654_onTap_runningActionsCount = 0;
var obj654_onTap_loopCount = 0;
obj654_onTap_actionGroup0();
});
