...
pubcoder.page.id = 13609;
pubcoder.page.title = "19";
pubcoder.page.number = 19;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj13617_onTap_activeActionGroupIndex = -1;
var obj13617_onTap_runningActionsCount = 0;
var obj13617_onTap_loopCount = 0;
...
obj13617_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13617_onTap_activeActionGroupIndex = -1;
		$("#obj13617").trigger("obj13617_onTap_ended");
		
		return;
	}
	window.obj13617_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page64
goToPage_14593();
function goToPage_14593() {
	var isPreview = false;
	if (isPreview) {
...
obj13617_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj13617: Event Touch Down
 *
 */
 
$("#obj13617").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13617_onTap_activeActionGroupIndex != -1) return;
var obj13617_onTap_runningActionsCount = 0;
var obj13617_onTap_loopCount = 0;
obj13617_onTap_actionGroup0();
});
...
$("#obj13610").trigger('SCEventShow');
$("#obj13613").trigger('SCEventShow');
$("#obj13615").trigger('SCEventShow');
$("#obj13617").trigger('SCEventShow');
$("#obj13623").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
