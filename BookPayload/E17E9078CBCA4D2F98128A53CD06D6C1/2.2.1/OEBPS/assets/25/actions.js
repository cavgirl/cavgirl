...
pubcoder.page.id = 13650;
pubcoder.page.title = "25";
pubcoder.page.number = 25;
pubcoder.page.alias = "";
...
var obj13658_onTouchDown_activeActionGroupIndex = -1;
var obj13658_onTouchDown_runningActionsCount = 0;
var obj13658_onTouchDown_loopCount = 0;
...
obj13658_onTouchDown_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13658_onTouchDown_activeActionGroupIndex = -1;
		$("#obj13658").trigger("obj13658_onTouchDown_ended");
		
		return;
	}
	window.obj13658_onTouchDown_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page24
goToPage_13662();
function goToPage_13662() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../24/page.xhtml');
	} else {
...
obj13658_onTouchDown_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13658_onTouchDown_activeActionGroupIndex = -1;
		$("#obj13658").trigger("obj13658_onTouchDown_ended");
...
$("#obj13658").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13658_onTap_activeActionGroupIndex != -1) return;
var obj13658_onTap_runningActionsCount = 0;
var obj13658_onTap_loopCount = 0;
 ...
 */
 ...
 if (window.SCuaosIsWindows) {
	SCPreventTouch("#obj13658");
	var winTarget = document.getElementById("obj13658");
	winTarget.addEventListener("MSGestureHold", function(e){ e.preventDefault() }, false);
	winTarget.addEventListener("contextmenu", function(e){e.preventDefault()}, false);	
 }
$("#obj13658").bind(window.touchDownEvent, function(event) {
	event.preventDefault();	
	window.eventObj = event; 
	if ((window['obj13658_onTouchUp_activeActionGroupIndex'] != undefined) && window.obj13658_onTouchUp_activeActionGroupIndex != -1) return;
	if (window.obj13658_onTouchDown_activeActionGroupIndex != -1) return;
var obj13658_onTouchDown_runningActionsCount = 0;
var obj13658_onTouchDown_loopCount = 0;
obj13658_onTouchDown_actionGroup0();
});
...
$("#obj13651").trigger('SCEventShow');
$("#obj13654").trigger('SCEventShow');
$("#obj13658").trigger('SCEventShow');
$("#obj13665").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
