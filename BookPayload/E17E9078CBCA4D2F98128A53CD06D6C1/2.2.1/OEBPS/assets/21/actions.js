...
pubcoder.page.id = 3674;
pubcoder.page.title = "1";
pubcoder.page.number = 21;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj11568_onLoad_activeActionGroupIndex = -1;
var obj11568_onLoad_runningActionsCount = 0;
var obj11568_onLoad_loopCount = 0;
...
obj11568_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj11568_onLoad_activeActionGroupIndex = -1;
		$("#obj11568").trigger("obj11568_onLoad_ended");
		
		return;
	}
	window.obj11568_onLoad_activeActionGroupIndex = 0;
...
wait_11571();
function wait_11571() {
	window.obj11568_onLoad_runningActionsCount = obj11568_onLoad_runningActionsCount + 1;
	setTimeout(function() {
		window.obj11568_onLoad_runningActionsCount = window.obj11568_onLoad_runningActionsCount - 1;
if (window.obj11568_onLoad_runningActionsCount == 0) {
	obj11568_onLoad_actionGroup1();
}
	}, 3000);
}
...
obj11568_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj11568_onLoad_activeActionGroupIndex = -1;
		$("#obj11568").trigger("obj11568_onLoad_ended");
...
function show_11572() {
	window.obj11568_onLoad_runningActionsCount = obj11568_onLoad_runningActionsCount + 1;
	$("#obj11568").fadeIn(1000, function() {
			setTimeout(function() {
				window.obj11568_onLoad_runningActionsCount = window.obj11568_onLoad_runningActionsCount - 1;
if (window.obj11568_onLoad_runningActionsCount == 0) {
	obj11568_onLoad_actionGroup2();
}
				$("#obj11568").trigger('SCEventShow');
			}, 1);
		}
	);
}
...
obj11568_onLoad_actionGroup2 = function(){
	...
	window.obj11568_onLoad_activeActionGroupIndex = 2;
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj11568_onLoad_activeActionGroupIndex != -1) return;
var obj11568_onLoad_runningActionsCount = 0;
var obj11568_onLoad_loopCount = 0;
obj11568_onLoad_actionGroup0();
});
...
$("#obj3716").bind(PubCoder.Events.Tap, function(event) {
	...
	if (window.obj3716_onTap_activeActionGroupIndex != -1) return;
var obj3716_onTap_runningActionsCount = 0;
var obj3716_onTap_loopCount = 0;
...
$("#obj3687").trigger('SCEventShow');
$("#obj12038").trigger('SCEventShow');
