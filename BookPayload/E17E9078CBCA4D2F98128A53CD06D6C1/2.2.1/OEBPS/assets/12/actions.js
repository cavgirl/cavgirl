 ...
 * 
 */
var obj11563_onLoad_activeActionGroupIndex = -1;
var obj11563_onLoad_runningActionsCount = 0;
var obj11563_onLoad_loopCount = 0;
var obj3663_onTap_activeActionGroupIndex = -1;
var obj3663_onTap_runningActionsCount = 0;
var obj3663_onTap_loopCount = 0;
...
obj11563_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj11563_onLoad_activeActionGroupIndex = -1;
		$("#obj11563").trigger("obj11563_onLoad_ended");
		
		return;
	}
	window.obj11563_onLoad_activeActionGroupIndex = 0;
...
wait_11566();
function wait_11566() {
	window.obj11563_onLoad_runningActionsCount = obj11563_onLoad_runningActionsCount + 1;
	setTimeout(function() {
		window.obj11563_onLoad_runningActionsCount = window.obj11563_onLoad_runningActionsCount - 1;
if (window.obj11563_onLoad_runningActionsCount == 0) {
	obj11563_onLoad_actionGroup1();
}
	}, 3000);
}
...
obj11563_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj11563_onLoad_activeActionGroupIndex = -1;
		$("#obj11563").trigger("obj11563_onLoad_ended");
...
function show_11567() {
	window.obj11563_onLoad_runningActionsCount = obj11563_onLoad_runningActionsCount + 1;
	$("#obj11563").fadeIn(1000, function() {
			setTimeout(function() {
				window.obj11563_onLoad_runningActionsCount = window.obj11563_onLoad_runningActionsCount - 1;
if (window.obj11563_onLoad_runningActionsCount == 0) {
	obj11563_onLoad_actionGroup2();
}
				$("#obj11563").trigger('SCEventShow');
			}, 1);
		}
	);
}
...
obj11563_onLoad_actionGroup2 = function(){
	...
	window.obj11563_onLoad_activeActionGroupIndex = 2;
...
obj3663_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3663_onTap_activeActionGroupIndex = -1;
		$("#obj3663").trigger("obj3663_onTap_ended");
		
		return;
	}
	window.obj3663_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page13
goToPage_3665();
function goToPage_3665() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../13/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(13))},200);
	}
}
...
obj3663_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj3663_onTap_activeActionGroupIndex = -1;
		$("#obj3663").trigger("obj3663_onTap_ended");
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj11563_onLoad_activeActionGroupIndex != -1) return;
var obj11563_onLoad_runningActionsCount = 0;
var obj11563_onLoad_loopCount = 0;
obj11563_onLoad_actionGroup0();
});
...
/*
 *
 *   obj3663: Event Touch Down
 *
 */
 
$("#obj3663").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj3663_onTap_activeActionGroupIndex != -1) return;
var obj3663_onTap_runningActionsCount = 0;
var obj3663_onTap_loopCount = 0;
obj3663_onTap_actionGroup0();
});
...
$("#obj3634").trigger('SCEventShow');
$("#obj12035").trigger('SCEventShow');
$("#obj3663").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
