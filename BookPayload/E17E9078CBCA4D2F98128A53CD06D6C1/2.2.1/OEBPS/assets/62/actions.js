...
pubcoder.page.id = 13907;
pubcoder.page.title = "62";
pubcoder.page.number = 62;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj13913_onTap_activeActionGroupIndex = -1;
var obj13913_onTap_runningActionsCount = 0;
var obj13913_onTap_loopCount = 0;
var obj13942_onTap_activeActionGroupIndex = -1;
var obj13942_onTap_runningActionsCount = 0;
var obj13942_onTap_loopCount = 0;
...
obj13913_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13913_onTap_activeActionGroupIndex = -1;
		$("#obj13913").trigger("obj13913_onTap_ended");
		
		return;
	}
	window.obj13913_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page64
goToPage_14747();
function goToPage_14747() {
	var isPreview = false;
	if (isPreview) {
...
obj13913_onTap_actionGroup1 = function(){
...
obj13942_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13942_onTap_activeActionGroupIndex = -1;
		$("#obj13942").trigger("obj13942_onTap_ended");
		
		return;
	}
	window.obj13942_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page64
goToPage_13944();
function goToPage_13944() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../64/page.xhtml');
	} else {
...
obj13942_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13942_onTap_activeActionGroupIndex = -1;
		$("#obj13942").trigger("obj13942_onTap_ended");
...
/*
 *
 *   obj13913: Event Touch Down
 *
 */
 
$("#obj13913").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13913_onTap_activeActionGroupIndex != -1) return;
var obj13913_onTap_runningActionsCount = 0;
var obj13913_onTap_loopCount = 0;
obj13913_onTap_actionGroup0();
});
...
/*
 *
 *   obj13942: Event Touch Down
 *
 */
 
$("#obj13942").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13942_onTap_activeActionGroupIndex != -1) return;
var obj13942_onTap_runningActionsCount = 0;
var obj13942_onTap_loopCount = 0;
obj13942_onTap_actionGroup0();
});
...
$("#obj13908").trigger('SCEventShow');
$("#obj13913").trigger('SCEventShow');
$("#obj13940").trigger('SCEventShow');
$("#obj13942").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
