...
pubcoder.page.id = 3833;
pubcoder.page.title = "1";
pubcoder.page.number = 44;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj11583_onLoad_activeActionGroupIndex = -1;
var obj11583_onLoad_runningActionsCount = 0;
var obj11583_onLoad_loopCount = 0;
var obj3875_onTap_activeActionGroupIndex = -1;
var obj3875_onTap_runningActionsCount = 0;
var obj3875_onTap_loopCount = 0;
...
obj11583_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj11583_onLoad_activeActionGroupIndex = -1;
		$("#obj11583").trigger("obj11583_onLoad_ended");
		
		return;
	}
	window.obj11583_onLoad_activeActionGroupIndex = 0;
...
wait_11586();
function wait_11586() {
	window.obj11583_onLoad_runningActionsCount = obj11583_onLoad_runningActionsCount + 1;
	setTimeout(function() {
		window.obj11583_onLoad_runningActionsCount = window.obj11583_onLoad_runningActionsCount - 1;
if (window.obj11583_onLoad_runningActionsCount == 0) {
	obj11583_onLoad_actionGroup1();
}
	}, 3000);
}
...
obj11583_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj11583_onLoad_activeActionGroupIndex = -1;
		$("#obj11583").trigger("obj11583_onLoad_ended");
...
function show_11587() {
	window.obj11583_onLoad_runningActionsCount = obj11583_onLoad_runningActionsCount + 1;
	$("#obj11583").fadeIn(1000, function() {
			setTimeout(function() {
				window.obj11583_onLoad_runningActionsCount = window.obj11583_onLoad_runningActionsCount - 1;
if (window.obj11583_onLoad_runningActionsCount == 0) {
	obj11583_onLoad_actionGroup2();
}
				$("#obj11583").trigger('SCEventShow');
			}, 1);
		}
	);
}
...
obj11583_onLoad_actionGroup2 = function(){
	...
	window.obj11583_onLoad_activeActionGroupIndex = 2;
...
obj3875_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3875_onTap_activeActionGroupIndex = -1;
		$("#obj3875").trigger("obj3875_onTap_ended");
		
		return;
	}
	window.obj3875_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page45
goToPage_3877();
function goToPage_3877() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../45/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(45))},200);
	}
}
...
obj3875_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj3875_onTap_activeActionGroupIndex = -1;
		$("#obj3875").trigger("obj3875_onTap_ended");
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj11583_onLoad_activeActionGroupIndex != -1) return;
var obj11583_onLoad_runningActionsCount = 0;
var obj11583_onLoad_loopCount = 0;
obj11583_onLoad_actionGroup0();
});
...
/*
 *
 *   obj3875: Event Touch Down
 *
 */
 
$("#obj3875").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj3875_onTap_activeActionGroupIndex != -1) return;
var obj3875_onTap_runningActionsCount = 0;
var obj3875_onTap_loopCount = 0;
obj3875_onTap_actionGroup0();
});
