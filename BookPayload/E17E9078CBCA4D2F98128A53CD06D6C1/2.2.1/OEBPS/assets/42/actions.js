...
pubcoder.page.id = 13790;
pubcoder.page.title = "42";
pubcoder.page.number = 42;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj13805_onTap_activeActionGroupIndex = -1;
var obj13805_onTap_runningActionsCount = 0;
var obj13805_onTap_loopCount = 0;
...
obj13805_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13805_onTap_activeActionGroupIndex = -1;
		$("#obj13805").trigger("obj13805_onTap_ended");
		
		return;
	}
	window.obj13805_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page64
goToPage_14590();
function goToPage_14590() {
	var isPreview = false;
	if (isPreview) {
...
obj13805_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj13805: Event Touch Down
 *
 */
 
$("#obj13805").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13805_onTap_activeActionGroupIndex != -1) return;
var obj13805_onTap_runningActionsCount = 0;
var obj13805_onTap_loopCount = 0;
obj13805_onTap_actionGroup0();
});
...
$("#obj13791").trigger('SCEventShow');
$("#obj13794").trigger('SCEventShow');
$("#obj13796").trigger('SCEventShow');
$("#obj13803").trigger('SCEventShow');
$("#obj13805").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
