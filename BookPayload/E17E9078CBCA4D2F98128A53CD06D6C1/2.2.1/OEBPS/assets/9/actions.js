 ...
 * 
 */
var obj15953_onTap_activeActionGroupIndex = -1;
var obj15953_onTap_runningActionsCount = 0;
var obj15953_onTap_loopCount = 0;
var obj15953_onTouchDown_activeActionGroupIndex = -1;
var obj15953_onTouchDown_runningActionsCount = 0;
var obj15953_onTouchDown_loopCount = 0;
...
obj15953_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj15953_onTap_activeActionGroupIndex = -1;
		$("#obj15953").trigger("obj15953_onTap_ended");
		
		return;
	}
	window.obj15953_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page8
goToPage_15955();
function goToPage_15955() {
	var isPreview = false;
	if (isPreview) {
...
obj15953_onTap_actionGroup1 = function(){
...
obj15953_onTouchDown_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj15953_onTouchDown_activeActionGroupIndex = -1;
		$("#obj15953").trigger("obj15953_onTouchDown_ended");
		
		return;
	}
	window.obj15953_onTouchDown_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page8
goToPage_15957();
function goToPage_15957() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../8/page.xhtml');
	} else {
...
obj15953_onTouchDown_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj15953_onTouchDown_activeActionGroupIndex = -1;
		$("#obj15953").trigger("obj15953_onTouchDown_ended");
...
/*
 *
 *   obj15953: Event Touch Down
 *
 */
 
$("#obj15953").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj15953_onTap_activeActionGroupIndex != -1) return;
var obj15953_onTap_runningActionsCount = 0;
var obj15953_onTap_loopCount = 0;
obj15953_onTap_actionGroup0();
});
 ...
 */
 ...
 if (window.SCuaosIsWindows) {
	SCPreventTouch("#obj15953");
	var winTarget = document.getElementById("obj15953");
	winTarget.addEventListener("MSGestureHold", function(e){ e.preventDefault() }, false);
	winTarget.addEventListener("contextmenu", function(e){e.preventDefault()}, false);	
 }
$("#obj15953").bind(window.touchDownEvent, function(event) {
	event.preventDefault();	
	window.eventObj = event; 
	if ((window['obj15953_onTouchUp_activeActionGroupIndex'] != undefined) && window.obj15953_onTouchUp_activeActionGroupIndex != -1) return;
	if (window.obj15953_onTouchDown_activeActionGroupIndex != -1) return;
var obj15953_onTouchDown_runningActionsCount = 0;
var obj15953_onTouchDown_loopCount = 0;
obj15953_onTouchDown_actionGroup0();
});
