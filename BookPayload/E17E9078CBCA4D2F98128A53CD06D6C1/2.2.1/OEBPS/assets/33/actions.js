...
pubcoder.page.id = 2650;
pubcoder.page.title = "33";
pubcoder.page.number = 33;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj3058_onTap_activeActionGroupIndex = -1;
var obj3058_onTap_runningActionsCount = 0;
var obj3058_onTap_loopCount = 0;
var obj13754_onTap_activeActionGroupIndex = -1;
var obj13754_onTap_runningActionsCount = 0;
var obj13754_onTap_loopCount = 0;
...
obj3058_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3058_onTap_activeActionGroupIndex = -1;
		$("#obj3058").trigger("obj3058_onTap_ended");
		
		return;
	}
	window.obj3058_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page36
goToPage_3060();
function goToPage_3060() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../36/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(36))},200);
	}
}
...
obj3058_onTap_actionGroup1 = function(){
...
obj13754_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13754_onTap_activeActionGroupIndex = -1;
		$("#obj13754").trigger("obj13754_onTap_ended");
		
		return;
	}
	window.obj13754_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page34
goToPage_13764();
function goToPage_13764() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../34/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(34))},200);
	}
}
...
obj13754_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13754_onTap_activeActionGroupIndex = -1;
		$("#obj13754").trigger("obj13754_onTap_ended");
...
/*
 *
 *   obj3058: Event Touch Down
 *
 */
 
$("#obj3058").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj3058_onTap_activeActionGroupIndex != -1) return;
var obj3058_onTap_runningActionsCount = 0;
var obj3058_onTap_loopCount = 0;
obj3058_onTap_actionGroup0();
});
...
/*
 *
 *   obj13754: Event Touch Down
 *
 */
 
$("#obj13754").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13754_onTap_activeActionGroupIndex != -1) return;
var obj13754_onTap_runningActionsCount = 0;
var obj13754_onTap_loopCount = 0;
obj13754_onTap_actionGroup0();
});
...
$("#obj2651").trigger('SCEventShow');
$("#obj3058").trigger('SCEventShow');
$("#obj12685").trigger('SCEventShow');
$("#obj12683").trigger('SCEventShow');
$("#obj13757").trigger('SCEventShow');
$("#obj13754").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
