...
pubcoder.page.id = 13667;
pubcoder.page.title = "26";
pubcoder.page.number = 26;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj13831_onTap_activeActionGroupIndex = -1;
var obj13831_onTap_runningActionsCount = 0;
var obj13831_onTap_loopCount = 0;
...
obj13831_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13831_onTap_activeActionGroupIndex = -1;
		$("#obj13831").trigger("obj13831_onTap_ended");
		
		return;
	}
	window.obj13831_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page64
goToPage_14592();
function goToPage_14592() {
	var isPreview = false;
	if (isPreview) {
...
obj13831_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj13831: Event Touch Down
 *
 */
 
$("#obj13831").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13831_onTap_activeActionGroupIndex != -1) return;
var obj13831_onTap_runningActionsCount = 0;
var obj13831_onTap_loopCount = 0;
obj13831_onTap_actionGroup0();
});
...
$("#obj13671").trigger('SCEventShow');
$("#obj13678").trigger('SCEventShow');
$("#obj13831").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
