 ...
 * 
 */
var obj11375_onLoad_activeActionGroupIndex = -1;
var obj11375_onLoad_runningActionsCount = 0;
var obj11375_onLoad_loopCount = 0;
var obj1420_onTap_activeActionGroupIndex = -1;
var obj1420_onTap_runningActionsCount = 0;
var obj1420_onTap_loopCount = 0;
...
obj11375_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj11375_onLoad_activeActionGroupIndex = -1;
		$("#obj11375").trigger("obj11375_onLoad_ended");
		
		return;
	}
	window.obj11375_onLoad_activeActionGroupIndex = 0;
...
wait_11378();
function wait_11378() {
	window.obj11375_onLoad_runningActionsCount = obj11375_onLoad_runningActionsCount + 1;
	setTimeout(function() {
		window.obj11375_onLoad_runningActionsCount = window.obj11375_onLoad_runningActionsCount - 1;
if (window.obj11375_onLoad_runningActionsCount == 0) {
	obj11375_onLoad_actionGroup1();
}
	}, 3000);
}
...
obj11375_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj11375_onLoad_activeActionGroupIndex = -1;
		$("#obj11375").trigger("obj11375_onLoad_ended");
...
function show_11379() {
	window.obj11375_onLoad_runningActionsCount = obj11375_onLoad_runningActionsCount + 1;
	$("#obj11375").fadeIn(1000, function() {
			setTimeout(function() {
				window.obj11375_onLoad_runningActionsCount = window.obj11375_onLoad_runningActionsCount - 1;
if (window.obj11375_onLoad_runningActionsCount == 0) {
	obj11375_onLoad_actionGroup2();
}
				$("#obj11375").trigger('SCEventShow');
			}, 1);
		}
	);
}
...
obj11375_onLoad_actionGroup2 = function(){
	...
	window.obj11375_onLoad_activeActionGroupIndex = 2;
...
obj1420_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1420_onTap_activeActionGroupIndex = -1;
		$("#obj1420").trigger("obj1420_onTap_ended");
		
		return;
	}
	window.obj1420_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page6
goToPage_3620();
function goToPage_3620() {
	var isPreview = false;
	if (isPreview) {
...
obj1420_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj1420_onTap_activeActionGroupIndex = -1;
		$("#obj1420").trigger("obj1420_onTap_ended");
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj11375_onLoad_activeActionGroupIndex != -1) return;
var obj11375_onLoad_runningActionsCount = 0;
var obj11375_onLoad_loopCount = 0;
obj11375_onLoad_actionGroup0();
});
...
/*
 *
 *   obj1420: Event Touch Down
 *
 */
 
$("#obj1420").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj1420_onTap_activeActionGroupIndex != -1) return;
var obj1420_onTap_runningActionsCount = 0;
var obj1420_onTap_loopCount = 0;
obj1420_onTap_actionGroup0();
});
...
$("#obj12078").trigger('SCEventShow');
$("#obj1420").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
