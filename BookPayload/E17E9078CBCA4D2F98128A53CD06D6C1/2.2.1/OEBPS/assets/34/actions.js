...
pubcoder.page.id = 13719;
pubcoder.page.title = "34";
pubcoder.page.number = 34;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj13725_onTap_activeActionGroupIndex = -1;
var obj13725_onTap_runningActionsCount = 0;
var obj13725_onTap_loopCount = 0;
var obj13725_onTouchDown_activeActionGroupIndex = -1;
var obj13725_onTouchDown_runningActionsCount = 0;
var obj13725_onTouchDown_loopCount = 0;
...
obj13725_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13725_onTap_activeActionGroupIndex = -1;
		$("#obj13725").trigger("obj13725_onTap_ended");
		
		return;
	}
	window.obj13725_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page33
goToPage_13727();
function goToPage_13727() {
	var isPreview = false;
	if (isPreview) {
...
obj13725_onTap_actionGroup1 = function(){
...
obj13725_onTouchDown_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13725_onTouchDown_activeActionGroupIndex = -1;
		$("#obj13725").trigger("obj13725_onTouchDown_ended");
		
		return;
	}
	window.obj13725_onTouchDown_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page33
goToPage_13729();
function goToPage_13729() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../33/page.xhtml');
	} else {
...
obj13725_onTouchDown_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13725_onTouchDown_activeActionGroupIndex = -1;
		$("#obj13725").trigger("obj13725_onTouchDown_ended");
...
/*
 *
 *   obj13725: Event Touch Down
 *
 */
 
$("#obj13725").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13725_onTap_activeActionGroupIndex != -1) return;
var obj13725_onTap_runningActionsCount = 0;
var obj13725_onTap_loopCount = 0;
obj13725_onTap_actionGroup0();
});
 ...
 */
 ...
 if (window.SCuaosIsWindows) {
	SCPreventTouch("#obj13725");
	var winTarget = document.getElementById("obj13725");
	winTarget.addEventListener("MSGestureHold", function(e){ e.preventDefault() }, false);
	winTarget.addEventListener("contextmenu", function(e){e.preventDefault()}, false);	
 }
$("#obj13725").bind(window.touchDownEvent, function(event) {
	event.preventDefault();	
	window.eventObj = event; 
	if ((window['obj13725_onTouchUp_activeActionGroupIndex'] != undefined) && window.obj13725_onTouchUp_activeActionGroupIndex != -1) return;
	if (window.obj13725_onTouchDown_activeActionGroupIndex != -1) return;
var obj13725_onTouchDown_runningActionsCount = 0;
var obj13725_onTouchDown_loopCount = 0;
obj13725_onTouchDown_actionGroup0();
});
...
$("#obj13720").trigger('SCEventShow');
$("#obj13775").trigger('SCEventShow');
$("#obj13725").trigger('SCEventShow');
$("#obj13773").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
