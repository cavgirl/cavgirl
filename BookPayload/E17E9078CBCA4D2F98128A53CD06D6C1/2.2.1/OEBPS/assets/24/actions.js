...
pubcoder.page.id = 1674;
pubcoder.page.title = "24";
pubcoder.page.number = 24;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj3055_onTap_activeActionGroupIndex = -1;
var obj3055_onTap_runningActionsCount = 0;
var obj3055_onTap_loopCount = 0;
var obj13632_onTap_activeActionGroupIndex = -1;
var obj13632_onTap_runningActionsCount = 0;
var obj13632_onTap_loopCount = 0;
...
obj3055_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3055_onTap_activeActionGroupIndex = -1;
		$("#obj3055").trigger("obj3055_onTap_ended");
		
		return;
	}
	window.obj3055_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page27
goToPage_3057();
function goToPage_3057() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../27/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(27))},200);
	}
}
...
obj3055_onTap_actionGroup1 = function(){
...
obj13632_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13632_onTap_activeActionGroupIndex = -1;
		$("#obj13632").trigger("obj13632_onTap_ended");
		
		return;
	}
	window.obj13632_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page25
goToPage_13765();
function goToPage_13765() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../25/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(25))},200);
	}
}
...
obj13632_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13632_onTap_activeActionGroupIndex = -1;
		$("#obj13632").trigger("obj13632_onTap_ended");
...
/*
 *
 *   obj3055: Event Touch Down
 *
 */
 
$("#obj3055").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj3055_onTap_activeActionGroupIndex != -1) return;
var obj3055_onTap_runningActionsCount = 0;
var obj3055_onTap_loopCount = 0;
obj3055_onTap_actionGroup0();
});
...
/*
 *
 *   obj13632: Event Touch Down
 *
 */
 
$("#obj13632").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13632_onTap_activeActionGroupIndex != -1) return;
var obj13632_onTap_runningActionsCount = 0;
var obj13632_onTap_loopCount = 0;
obj13632_onTap_actionGroup0();
});
...
$("#obj1675").trigger('SCEventShow');
$("#obj3055").trigger('SCEventShow');
$("#obj12640").trigger('SCEventShow');
$("#obj12638").trigger('SCEventShow');
$("#obj13625").trigger('SCEventShow');
$("#obj13632").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
