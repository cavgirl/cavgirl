...
pubcoder.page.id = 3088;
pubcoder.page.title = "41";
pubcoder.page.number = 41;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj13785_onTap_activeActionGroupIndex = -1;
var obj13785_onTap_runningActionsCount = 0;
var obj13785_onTap_loopCount = 0;
var obj13785_onTouchDown_activeActionGroupIndex = -1;
var obj13785_onTouchDown_runningActionsCount = 0;
var obj13785_onTouchDown_loopCount = 0;
...
obj13785_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13785_onTap_activeActionGroupIndex = -1;
		$("#obj13785").trigger("obj13785_onTap_ended");
		
		return;
	}
	window.obj13785_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page40
goToPage_13787();
function goToPage_13787() {
	var isPreview = false;
	if (isPreview) {
...
obj13785_onTap_actionGroup1 = function(){
...
obj13785_onTouchDown_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13785_onTouchDown_activeActionGroupIndex = -1;
		$("#obj13785").trigger("obj13785_onTouchDown_ended");
		
		return;
	}
	window.obj13785_onTouchDown_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page40
goToPage_13789();
function goToPage_13789() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../40/page.xhtml');
	} else {
...
obj13785_onTouchDown_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13785_onTouchDown_activeActionGroupIndex = -1;
		$("#obj13785").trigger("obj13785_onTouchDown_ended");
...
/*
 *
 *   obj13785: Event Touch Down
 *
 */
 
$("#obj13785").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13785_onTap_activeActionGroupIndex != -1) return;
var obj13785_onTap_runningActionsCount = 0;
var obj13785_onTap_loopCount = 0;
obj13785_onTap_actionGroup0();
});
 ...
 */
 ...
 if (window.SCuaosIsWindows) {
	...
	var winTarget = document.getElementById("obj13785");
	winTarget.addEventListener("MSGestureHold", function(e){ e.preventDefault() }, false);
	winTarget.addEventListener("contextmenu", function(e){e.preventDefault()}, false);	
 }
$("#obj13785").bind(window.touchDownEvent, function(event) {
	event.preventDefault();	
	window.eventObj = event; 
	if ((window['obj13785_onTouchUp_activeActionGroupIndex'] != undefined) && window.obj13785_onTouchUp_activeActionGroupIndex != -1) return;
	if (window.obj13785_onTouchDown_activeActionGroupIndex != -1) return;
var obj13785_onTouchDown_runningActionsCount = 0;
var obj13785_onTouchDown_loopCount = 0;
obj13785_onTouchDown_actionGroup0();
});
...
$("#obj3089").trigger('SCEventShow');
$("#obj13783").trigger('SCEventShow');
$("#obj12748").trigger('SCEventShow');
