...
pubcoder.page.id = 1905;
pubcoder.page.title = "61";
pubcoder.page.number = 61;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj1916_onTap_activeActionGroupIndex = -1;
var obj1916_onTap_runningActionsCount = 0;
var obj1916_onTap_loopCount = 0;
var obj13935_onTap_activeActionGroupIndex = -1;
var obj13935_onTap_runningActionsCount = 0;
var obj13935_onTap_loopCount = 0;
...
obj1916_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj1916_onTap_activeActionGroupIndex = -1;
		$("#obj1916").trigger("obj1916_onTap_ended");
		
		return;
	}
	window.obj1916_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page63
goToPage_14658();
function goToPage_14658() {
	var isPreview = false;
	if (isPreview) {
...
obj1916_onTap_actionGroup1 = function(){
...
obj13935_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13935_onTap_activeActionGroupIndex = -1;
		$("#obj13935").trigger("obj13935_onTap_ended");
		
		return;
	}
	window.obj13935_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page62
goToPage_13937();
function goToPage_13937() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../62/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(62))},200);
	}
}
...
obj13935_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13935_onTap_activeActionGroupIndex = -1;
		$("#obj13935").trigger("obj13935_onTap_ended");
...
/*
 *
 *   obj1916: Event Touch Down
 *
 */
 
$("#obj1916").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj1916_onTap_activeActionGroupIndex != -1) return;
var obj1916_onTap_runningActionsCount = 0;
var obj1916_onTap_loopCount = 0;
obj1916_onTap_actionGroup0();
});
...
/*
 *
 *   obj13935: Event Touch Down
 *
 */
 
$("#obj13935").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13935_onTap_activeActionGroupIndex != -1) return;
var obj13935_onTap_runningActionsCount = 0;
var obj13935_onTap_loopCount = 0;
obj13935_onTap_actionGroup0();
});
...
$("#obj1916").trigger('SCEventShow');
$("#obj12814").trigger('SCEventShow');
$("#obj12812").trigger('SCEventShow');
$("#obj13938").trigger('SCEventShow');
$("#obj13935").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
