...
pubcoder.page.id = 2463;
pubcoder.page.title = "40";
pubcoder.page.number = 40;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj3061_onTap_activeActionGroupIndex = -1;
var obj3061_onTap_runningActionsCount = 0;
var obj3061_onTap_loopCount = 0;
var obj13778_onTap_activeActionGroupIndex = -1;
var obj13778_onTap_runningActionsCount = 0;
var obj13778_onTap_loopCount = 0;
...
obj3061_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3061_onTap_activeActionGroupIndex = -1;
		$("#obj3061").trigger("obj3061_onTap_ended");
		
		return;
	}
	window.obj3061_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page43
goToPage_3063();
function goToPage_3063() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../43/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(43))},200);
	}
}
...
obj3061_onTap_actionGroup1 = function(){
...
obj13778_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13778_onTap_activeActionGroupIndex = -1;
		$("#obj13778").trigger("obj13778_onTap_ended");
		
		return;
	}
	window.obj13778_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page41
goToPage_13780();
function goToPage_13780() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../41/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(41))},200);
	}
}
...
obj13778_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13778_onTap_activeActionGroupIndex = -1;
		$("#obj13778").trigger("obj13778_onTap_ended");
...
/*
 *
 *   obj3061: Event Touch Down
 *
 */
 
$("#obj3061").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj3061_onTap_activeActionGroupIndex != -1) return;
var obj3061_onTap_runningActionsCount = 0;
var obj3061_onTap_loopCount = 0;
obj3061_onTap_actionGroup0();
});
...
/*
 *
 *   obj13778: Event Touch Down
 *
 */
 
$("#obj13778").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13778_onTap_activeActionGroupIndex != -1) return;
var obj13778_onTap_runningActionsCount = 0;
var obj13778_onTap_loopCount = 0;
obj13778_onTap_actionGroup0();
});
...
$("#obj3061").trigger('SCEventShow');
$("#obj12728").trigger('SCEventShow');
$("#obj12726").trigger('SCEventShow');
$("#obj13781").trigger('SCEventShow');
$("#obj13778").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
