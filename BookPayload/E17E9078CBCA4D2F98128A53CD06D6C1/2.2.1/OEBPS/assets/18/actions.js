...
pubcoder.page.id = 13576;
pubcoder.page.title = "18";
pubcoder.page.number = 18;
pubcoder.page.alias = "";
...
var obj13584_onTouchDown_activeActionGroupIndex = -1;
var obj13584_onTouchDown_runningActionsCount = 0;
var obj13584_onTouchDown_loopCount = 0;
...
obj13584_onTouchDown_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13584_onTouchDown_activeActionGroupIndex = -1;
		$("#obj13584").trigger("obj13584_onTouchDown_ended");
		
		return;
	}
	window.obj13584_onTouchDown_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page17
goToPage_13588();
function goToPage_13588() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../17/page.xhtml');
	} else {
...
obj13584_onTouchDown_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13584_onTouchDown_activeActionGroupIndex = -1;
		$("#obj13584").trigger("obj13584_onTouchDown_ended");
...
$("#obj13584").bind(PubCoder.Events.Tap, function(event) {
	...
	if (window.obj13584_onTap_activeActionGroupIndex != -1) return;
var obj13584_onTap_runningActionsCount = 0;
var obj13584_onTap_loopCount = 0;
 ...
 */
 ...
 if (window.SCuaosIsWindows) {
	SCPreventTouch("#obj13584");
	var winTarget = document.getElementById("obj13584");
	winTarget.addEventListener("MSGestureHold", function(e){ e.preventDefault() }, false);
	winTarget.addEventListener("contextmenu", function(e){e.preventDefault()}, false);	
 }
$("#obj13584").bind(window.touchDownEvent, function(event) {
	event.preventDefault();	
	window.eventObj = event; 
	if ((window['obj13584_onTouchUp_activeActionGroupIndex'] != undefined) && window.obj13584_onTouchUp_activeActionGroupIndex != -1) return;
	if (window.obj13584_onTouchDown_activeActionGroupIndex != -1) return;
var obj13584_onTouchDown_runningActionsCount = 0;
var obj13584_onTouchDown_loopCount = 0;
obj13584_onTouchDown_actionGroup0();
});
...
$("#obj13577").trigger('SCEventShow');
$("#obj13580").trigger('SCEventShow');
$("#obj13582").trigger('SCEventShow');
$("#obj13584").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
