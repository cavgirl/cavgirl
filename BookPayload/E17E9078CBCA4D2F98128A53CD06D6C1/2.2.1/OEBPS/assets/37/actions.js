...
pubcoder.page.id = 15565;
pubcoder.page.title = "1";
pubcoder.page.number = 37;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj15570_onLoad_activeActionGroupIndex = -1;
var obj15570_onLoad_runningActionsCount = 0;
var obj15570_onLoad_loopCount = 0;
var obj15575_onTap_activeActionGroupIndex = -1;
var obj15575_onTap_runningActionsCount = 0;
var obj15575_onTap_loopCount = 0;
...
obj15570_onLoad_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj15570_onLoad_activeActionGroupIndex = -1;
		$("#obj15570").trigger("obj15570_onLoad_ended");
		
		return;
	}
	window.obj15570_onLoad_activeActionGroupIndex = 0;
...
wait_15573();
function wait_15573() {
	window.obj15570_onLoad_runningActionsCount = obj15570_onLoad_runningActionsCount + 1;
	setTimeout(function() {
		window.obj15570_onLoad_runningActionsCount = window.obj15570_onLoad_runningActionsCount - 1;
if (window.obj15570_onLoad_runningActionsCount == 0) {
	obj15570_onLoad_actionGroup1();
}
	}, 3000);
}
...
obj15570_onLoad_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj15570_onLoad_activeActionGroupIndex = -1;
		$("#obj15570").trigger("obj15570_onLoad_ended");
...
function show_15574() {
	window.obj15570_onLoad_runningActionsCount = obj15570_onLoad_runningActionsCount + 1;
	$("#obj15570").fadeIn(1000, function() {
			setTimeout(function() {
				window.obj15570_onLoad_runningActionsCount = window.obj15570_onLoad_runningActionsCount - 1;
if (window.obj15570_onLoad_runningActionsCount == 0) {
	obj15570_onLoad_actionGroup2();
}
				$("#obj15570").trigger('SCEventShow');
			}, 1);
		}
	);
}
...
obj15570_onLoad_actionGroup2 = function(){
	...
	window.obj15570_onLoad_activeActionGroupIndex = 2;
...
obj15575_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj15575_onTap_activeActionGroupIndex = -1;
		$("#obj15575").trigger("obj15575_onTap_ended");
		
		return;
	}
	window.obj15575_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page38
goToPage_15577();
function goToPage_15577() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../38/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(38))},200);
	}
}
...
obj15575_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj15575_onTap_activeActionGroupIndex = -1;
		$("#obj15575").trigger("obj15575_onTap_ended");
...
$(window).bind(PubCoder.Events.PageReady, function(event) {
	if (window.obj15570_onLoad_activeActionGroupIndex != -1) return;
var obj15570_onLoad_runningActionsCount = 0;
var obj15570_onLoad_loopCount = 0;
obj15570_onLoad_actionGroup0();
});
...
/*
 *
 *   obj15575: Event Touch Down
 *
 */
 
$("#obj15575").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj15575_onTap_activeActionGroupIndex != -1) return;
var obj15575_onTap_runningActionsCount = 0;
var obj15575_onTap_loopCount = 0;
obj15575_onTap_actionGroup0();
});
...
$("#obj15566").trigger('SCEventShow');
$("#obj15568").trigger('SCEventShow');
$("#obj15575").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
