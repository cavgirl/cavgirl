...
pubcoder.page.id = 3886;
pubcoder.page.title = "1";
pubcoder.page.number = 56;
pubcoder.page.alias = "";
...
var obj12089_onTap_activeActionGroupIndex = -1;
var obj12089_onTap_runningActionsCount = 0;
var obj12089_onTap_loopCount = 0;
...
function goToPage_12088() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../57/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(57))},200);
	}
}
...
obj12089_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj12089_onTap_activeActionGroupIndex = -1;
		$("#obj12089").trigger("obj12089_onTap_ended");
		
		return;
	}
	window.obj12089_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page59
goToPage_12091();
function goToPage_12091() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../59/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(59))},200);
	}
}
...
obj12089_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj12089_onTap_activeActionGroupIndex = -1;
		$("#obj12089").trigger("obj12089_onTap_ended");
...
$("#obj12086").bind(PubCoder.Events.Tap, function(event) {
	...
	if (window.obj12086_onTap_activeActionGroupIndex != -1) return;
var obj12086_onTap_runningActionsCount = 0;
var obj12086_onTap_loopCount = 0;
...
/*
 *
 *   obj12089: Event Touch Down
 *
 */
 
$("#obj12089").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj12089_onTap_activeActionGroupIndex != -1) return;
var obj12089_onTap_runningActionsCount = 0;
var obj12089_onTap_loopCount = 0;
obj12089_onTap_actionGroup0();
});
