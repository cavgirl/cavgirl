...
pubcoder.page.id = 13887;
pubcoder.page.title = "54";
pubcoder.page.number = 54;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj14206_onTap_activeActionGroupIndex = -1;
var obj14206_onTap_runningActionsCount = 0;
var obj14206_onTap_loopCount = 0;
...
obj14206_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj14206_onTap_activeActionGroupIndex = -1;
		$("#obj14206").trigger("obj14206_onTap_ended");
		
		return;
	}
	window.obj14206_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page64
goToPage_14208();
function goToPage_14208() {
	var isPreview = false;
	if (isPreview) {
...
obj14206_onTap_actionGroup1 = function(){
...
/*
 *
 *   obj14206: Event Touch Down
 *
 */
 
$("#obj14206").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj14206_onTap_activeActionGroupIndex != -1) return;
var obj14206_onTap_runningActionsCount = 0;
var obj14206_onTap_loopCount = 0;
obj14206_onTap_actionGroup0();
});
...
$("#obj13888").trigger('SCEventShow');
$("#obj13891").trigger('SCEventShow');
$("#obj13893").trigger('SCEventShow');
$("#obj13905").trigger('SCEventShow');
$("#obj14206").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
