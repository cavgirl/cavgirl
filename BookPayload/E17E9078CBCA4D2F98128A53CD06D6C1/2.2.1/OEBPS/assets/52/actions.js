...
pubcoder.page.id = 2838;
pubcoder.page.title = "52";
pubcoder.page.number = 52;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj3064_onTap_activeActionGroupIndex = -1;
var obj3064_onTap_runningActionsCount = 0;
var obj3064_onTap_loopCount = 0;
var obj13836_onTap_activeActionGroupIndex = -1;
var obj13836_onTap_runningActionsCount = 0;
var obj13836_onTap_loopCount = 0;
...
obj3064_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3064_onTap_activeActionGroupIndex = -1;
		$("#obj3064").trigger("obj3064_onTap_ended");
		
		return;
	}
	window.obj3064_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page55
goToPage_3066();
function goToPage_3066() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../55/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(55))},200);
	}
}
...
obj3064_onTap_actionGroup1 = function(){
...
obj13836_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13836_onTap_activeActionGroupIndex = -1;
		$("#obj13836").trigger("obj13836_onTap_ended");
		
		return;
	}
	window.obj13836_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page53
goToPage_13838();
function goToPage_13838() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../53/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(53))},200);
	}
}
...
obj13836_onTap_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj13836_onTap_activeActionGroupIndex = -1;
		$("#obj13836").trigger("obj13836_onTap_ended");
...
/*
 *
 *   obj3064: Event Touch Down
 *
 */
 
$("#obj3064").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj3064_onTap_activeActionGroupIndex != -1) return;
var obj3064_onTap_runningActionsCount = 0;
var obj3064_onTap_loopCount = 0;
obj3064_onTap_actionGroup0();
});
...
/*
 *
 *   obj13836: Event Touch Down
 *
 */
 
$("#obj13836").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13836_onTap_activeActionGroupIndex != -1) return;
var obj13836_onTap_runningActionsCount = 0;
var obj13836_onTap_loopCount = 0;
obj13836_onTap_actionGroup0();
});
...
$("#obj2839").trigger('SCEventShow');
$("#obj3064").trigger('SCEventShow');
$("#obj12771").trigger('SCEventShow');
$("#obj13839").trigger('SCEventShow');
$("#obj13836").trigger('SCEventShow');
$("#obj14259").trigger('SCEventShow');
$("#obj16105").trigger('SCEventShow');
