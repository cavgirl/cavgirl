...
pubcoder.page.id = 3106;
pubcoder.page.title = "35";
pubcoder.page.number = 35;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj13766_onTap_activeActionGroupIndex = -1;
var obj13766_onTap_runningActionsCount = 0;
var obj13766_onTap_loopCount = 0;
...
obj13766_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13766_onTap_activeActionGroupIndex = -1;
		$("#obj13766").trigger("obj13766_onTap_ended");
		
		return;
	}
	window.obj13766_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page64
goToPage_14591();
function goToPage_14591() {
	var isPreview = false;
	if (isPreview) {
...
obj13766_onTap_actionGroup1 = function(){
...
$("#obj13766").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13766_onTap_activeActionGroupIndex != -1) return;
var obj13766_onTap_runningActionsCount = 0;
var obj13766_onTap_loopCount = 0;
obj13766_onTap_actionGroup0();
});
...
$("#obj3107").trigger('SCEventShow');
$("#obj12869").trigger('SCEventShow');
$("#obj12705").trigger('SCEventShow');
$("#obj13771").trigger('SCEventShow');
