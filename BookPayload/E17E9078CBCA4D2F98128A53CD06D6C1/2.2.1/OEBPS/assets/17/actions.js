...
pubcoder.page.id = 13556;
pubcoder.page.title = "17";
pubcoder.page.number = 17;
pubcoder.page.alias = "";
 ...
 * 
 */
var obj13561_onTap_activeActionGroupIndex = -1;
var obj13561_onTap_runningActionsCount = 0;
var obj13561_onTap_loopCount = 0;
...
obj13561_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj13561_onTap_activeActionGroupIndex = -1;
		$("#obj13561").trigger("obj13561_onTap_ended");
		
		return;
	}
	window.obj13561_onTap_activeActionGroupIndex = 0;
	
//	action: goToPage
//	target: page20
goToPage_13563();
function goToPage_13563() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../20/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(20))},200);
	}
}
...
obj13561_onTap_actionGroup1 = function(){
...
//	target: page18
goToPage_13830();
function goToPage_13830() {
	var isPreview = false;
	if (isPreview) {
		$(location).attr('href', '../18/page.xhtml');
	} else {
		setTimeout(function(){ parent.SCHtmlController.goToPageViewer(parent.SCHtmlController.getPageForView(18))},200);
	}
}
...
/*
 *
 *   obj13561: Event Touch Down
 *
 */
 
$("#obj13561").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13561_onTap_activeActionGroupIndex != -1) return;
var obj13561_onTap_runningActionsCount = 0;
var obj13561_onTap_loopCount = 0;
obj13561_onTap_actionGroup0();
});
...
$("#obj13573").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj13573_onTap_activeActionGroupIndex != -1) return;
var obj13573_onTap_runningActionsCount = 0;
var obj13573_onTap_loopCount = 0;
...
$("#obj13557").trigger('SCEventShow');
$("#obj13559").trigger('SCEventShow');
$("#obj13561").trigger('SCEventShow');
