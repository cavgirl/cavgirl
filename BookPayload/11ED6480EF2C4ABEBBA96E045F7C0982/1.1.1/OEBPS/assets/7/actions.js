...
var obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_activeActionGroupIndex = -1;
var obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_runningActionsCount = 0;
var obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_loopCount = 0;
...
var obj5918_onShow_activeActionGroupIndex = -1;
var obj5918_onShow_runningActionsCount = 0;
var obj5918_onShow_loopCount = 0;
var obj6876_onTap_activeActionGroupIndex = -1;
var obj6876_onTap_runningActionsCount = 0;
var obj6876_onTap_loopCount = 0;
var obj6876_onDrag_activeActionGroupIndex = -1;
var obj6876_onDrag_runningActionsCount = 0;
var obj6876_onDrag_loopCount = 0;
var obj6876_onTouchDown_activeActionGroupIndex = -1;
var obj6876_onTouchDown_runningActionsCount = 0;
var obj6876_onTouchDown_loopCount = 0;
var obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_activeActionGroupIndex = -1;
var obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_runningActionsCount = 0;
var obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_loopCount = 0;
...
if (window.obj2613_onTouchDown_runningActionsCount == 0) {
	obj2613_onTouchDown_actionGroup1();
		...
		if (dropped_2616) {
			...
			$("#obj2613").trigger('SCActionDragDrop2616_droppedOutsideTargetActions');
		}
    });
}
...
obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_actionGroup0 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_activeActionGroupIndex = -1;
		$("#obj2613").trigger("obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_ended");
		
		return;
	}
	window.obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_activeActionGroupIndex = 0;
...
function show_2620() {
	...
	if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			...
			window.obj2613_droppedInsideTargetActions_runningActionsCount = window.obj2613_droppedInsideTargetActions_runningActionsCount - 1;
if (window.obj2613_droppedInsideTargetActions_runningActionsCount == 0) {
	obj2613_droppedInsideTargetActions_actionGroup3();
}
...
obj2613_droppedInsideTargetActions_actionGroup3 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj2613_droppedInsideTargetActions_activeActionGroupIndex = -1;
		$("#obj2613").trigger("obj2613_droppedInsideTargetActions_ended");
	...
	window.obj2613_droppedInsideTargetActions_activeActionGroupIndex = 3;
...
obj2662_SCEventCounterReachedTargetValue_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj2662_SCEventCounterReachedTargetValue_activeActionGroupIndex = -1;
		$("#obj2662").trigger("obj2662_SCEventCounterReachedTargetValue_ended");
	...
	window.obj2662_SCEventCounterReachedTargetValue_activeActionGroupIndex = 2;
...
obj5918_onShow_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5918_onShow_activeActionGroupIndex = -1;
		$("#obj5918").trigger("obj5918_onShow_ended");
		
		return;
	}
	window.obj5918_onShow_activeActionGroupIndex = 0;
...
wait_6526();
function wait_6526() {
	window.obj5918_onShow_runningActionsCount = obj5918_onShow_runningActionsCount + 1;
	setTimeout(function() {
		window.obj5918_onShow_runningActionsCount = window.obj5918_onShow_runningActionsCount - 1;
if (window.obj5918_onShow_runningActionsCount == 0) {
	obj5918_onShow_actionGroup1();
}
	}, 2000);
}
...
obj5918_onShow_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj5918_onShow_activeActionGroupIndex = -1;
		$("#obj5918").trigger("obj5918_onShow_ended");
...
obj5918_onShow_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj5918_onShow_activeActionGroupIndex = -1;
		$("#obj5918").trigger("obj5918_onShow_ended");
	...
	window.obj5918_onShow_activeActionGroupIndex = 2;
...
obj6876_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6876_onTap_activeActionGroupIndex = -1;
		$("#obj6876").trigger("obj6876_onTap_ended");
		
		return;
	}
	window.obj6876_onTap_activeActionGroupIndex = 0;
...
function hide_6878() {
	...
	window.obj6876_onTap_runningActionsCount = obj6876_onTap_runningActionsCount + 1;
	...
	if ($(element).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(element).css("display", "none");
			window.obj6876_onTap_runningActionsCount = window.obj6876_onTap_runningActionsCount - 1;
if (window.obj6876_onTap_runningActionsCount == 0) {
	obj6876_onTap_actionGroup1();
}
		}, 1);
		return;
	};
...
obj6876_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6876_onTap_activeActionGroupIndex = -1;
		$("#obj6876").trigger("obj6876_onTap_ended");
...
obj6876_onTap_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj6876_onTap_activeActionGroupIndex = -1;
		$("#obj6876").trigger("obj6876_onTap_ended");
	...
	window.obj6876_onTap_activeActionGroupIndex = 2;
...
obj6876_onTouchDown_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6876_onTouchDown_activeActionGroupIndex = -1;
		$("#obj6876").trigger("obj6876_onTouchDown_ended");
		
		return;
	}
	window.obj6876_onTouchDown_activeActionGroupIndex = 0;
...
function hide_6901() {
	...
	window.obj6876_onTouchDown_runningActionsCount = obj6876_onTouchDown_runningActionsCount + 1;
	...
	if ($(element).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(element).css("display", "none");
			window.obj6876_onTouchDown_runningActionsCount = window.obj6876_onTouchDown_runningActionsCount - 1;
if (window.obj6876_onTouchDown_runningActionsCount == 0) {
	obj6876_onTouchDown_actionGroup1();
}
		}, 1);
		return;
	};
...
obj6876_onTouchDown_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6876_onTouchDown_activeActionGroupIndex = -1;
		$("#obj6876").trigger("obj6876_onTouchDown_ended");
...
function show_6918() {
	...
	if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			...
			window.obj6876_onTouchDown_runningActionsCount = window.obj6876_onTouchDown_runningActionsCount - 1;
if (window.obj6876_onTouchDown_runningActionsCount == 0) {
	obj6876_onTouchDown_actionGroup2();
}
			$(element).trigger('SCEventShow');
		}, 1);
		return;
...
obj6876_onTouchDown_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6876_onTouchDown_activeActionGroupIndex = -1;
		$("#obj6876").trigger("obj6876_onTouchDown_ended");
	...
	window.obj6876_onTouchDown_activeActionGroupIndex = 2;
...
//prevent windows
if (window.SCuaosIsWindows)
	SCPreventTouch("#obj6876");
//	action: dragDrop
//	target: obj6876 
dragDrop_6897();
function dragDrop_6897() {
	event = window.eventObj;
	event.stopPropagation();
	window.obj6876_onTouchDown_runningActionsCount = obj6876_onTouchDown_runningActionsCount + 1;
    ...
    $(this).bind(window.touchUpEvent,function(e){
    	...
    	window.obj6876_onTouchDown_runningActionsCount = window.obj6876_onTouchDown_runningActionsCount - 1;
if (window.obj6876_onTouchDown_runningActionsCount == 0) {
	obj6876_onTouchDown_actionGroup3();
}
    	//define droppable elements
    	var droppableElements = new Array();
    	var actionsOnDrop = new Array() //for example: "SCActionDragDrop4180_droppedInsideTargetActions","SCActionDragDrop4180_droppedInsideTargetActions2";
    	var dropped_6897 = false;
    	var dropped_id_6897;
    	var eventType;
    	if (window.touchUpEvent == "touchend") {
    		x = e.changedTouches[0].clientX;
		...
		if (droppableElements.length != 0) {
			for (var i = droppableElements.length-1; i >= 0; i--)
			{
				if (isLocationInElementDragDropOffset(droppableElements[i], x, y))
				{
					objectIndex = i;
					dropped_6897 = true;
					dropped_id_6897 = droppableElements[i];
					break;
				}
			}
		} 
		if (dropped_6897) {
			...
			$("#obj6876").trigger('SCActionDragDrop6897_droppedOutsideTargetActions');
		}
    });
}
...
obj6876_onTouchDown_actionGroup3 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj6876_onTouchDown_activeActionGroupIndex = -1;
		$("#obj6876").trigger("obj6876_onTouchDown_ended");
	...
	window.obj6876_onTouchDown_activeActionGroupIndex = 3;
...
obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_activeActionGroupIndex = -1;
		$("#obj6876").trigger("obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_ended");
		
		return;
	}
	window.obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_activeActionGroupIndex = 0;
...
function hide_6899() {
	...
	window.obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_runningActionsCount = obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_runningActionsCount + 1;
	...
	if ($(element).css("display") == "none" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(element).css("display", "none");
			window.obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_runningActionsCount = window.obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_runningActionsCount - 1;
if (window.obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_runningActionsCount == 0) {
	obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_actionGroup1();
}
		}, 1);
		return;
	};
...
obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_actionGroup1 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_activeActionGroupIndex = -1;
		$("#obj6876").trigger("obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_ended");
...
/*
 *
 *   obj2613: Event SCActionDragDrop2616_droppedOutsideTargetActions
 *
 */
$("#obj2613").bind("SCActionDragDrop2616_droppedOutsideTargetActions", function(event) {
	if (window.obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_activeActionGroupIndex != -1) return;
var obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_runningActionsCount = 0;
var obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_loopCount = 0;
obj2613_SCActionDragDrop2616_droppedOutsideTargetActions_actionGroup0();
});
/*
 *
...
$("#obj5918").bind('SCEventShow', function(event) {
	if (window.obj5918_onShow_activeActionGroupIndex != -1) return;
var obj5918_onShow_runningActionsCount = 0;
var obj5918_onShow_loopCount = 0;
obj5918_onShow_actionGroup0();
});
...
/*
 *
 *   obj6876: Event Touch Down
 *
 */
 
$("#obj6876").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj6876_onTap_activeActionGroupIndex != -1) return;
var obj6876_onTap_runningActionsCount = 0;
var obj6876_onTap_loopCount = 0;
obj6876_onTap_actionGroup0();
});
 ...
 */
 ...
 if (window.SCuaosIsWindows) {
	SCPreventTouch("#obj6876");
	var winTarget = document.getElementById("obj6876");
	winTarget.addEventListener("MSGestureHold", function(e){ e.preventDefault() }, false);
	winTarget.addEventListener("contextmenu", function(e){e.preventDefault()}, false);	
 }
$("#obj6876").bind(window.touchDownEvent, function(event) {
	event.preventDefault();	
	window.eventObj = event; 
	if ((window['obj6876_onTouchUp_activeActionGroupIndex'] != undefined) && window.obj6876_onTouchUp_activeActionGroupIndex != -1) return;
	if (window.obj6876_onTouchDown_activeActionGroupIndex != -1) return;
var obj6876_onTouchDown_runningActionsCount = 0;
var obj6876_onTouchDown_loopCount = 0;
obj6876_onTouchDown_actionGroup0();
});


/*
 *
 *   obj6876: Event SCActionDragDrop6897_droppedOutsideTargetActions
 *
 */
$("#obj6876").bind("SCActionDragDrop6897_droppedOutsideTargetActions", function(event) {
	if (window.obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_activeActionGroupIndex != -1) return;
var obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_runningActionsCount = 0;
var obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_loopCount = 0;
obj6876_SCActionDragDrop6897_droppedOutsideTargetActions_actionGroup0();
});
...
$("#obj5795").trigger('SCEventShow');
$("#obj2613").trigger('SCEventShow');
$("#obj2488").trigger('SCEventShow');
$("#obj2605").trigger('SCEventShow');
$("#obj2597").trigger('SCEventShow');
$("#obj2589").trigger('SCEventShow');
$("#obj2628").trigger('SCEventShow');
$("#obj2636").trigger('SCEventShow');
$("#obj2735").trigger('SCEventShow');
$("#obj2726").trigger('SCEventShow');
$("#obj2719").trigger('SCEventShow');
$("#obj2712").trigger('SCEventShow');
$("#obj2705").trigger('SCEventShow');
$("#obj2698").trigger('SCEventShow');
$("#obj2691").trigger('SCEventShow');
$("#obj2742").trigger('SCEventShow');
$("#obj2749").trigger('SCEventShow');
$("#obj6876").trigger('SCEventShow');
