...
var obj3285_onTap_activeActionGroupIndex = -1;
var obj3285_onTap_runningActionsCount = 0;
var obj3285_onTap_loopCount = 0;
var obj3288_onShow_activeActionGroupIndex = -1;
var obj3288_onShow_runningActionsCount = 0;
var obj3288_onShow_loopCount = 0;
...
obj3285_onTap_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3285_onTap_activeActionGroupIndex = -1;
		$("#obj3285").trigger("obj3285_onTap_ended");
		
		return;
	}
	window.obj3285_onTap_activeActionGroupIndex = 0;
...
//	target: obj3534 
runActionList_4330();
function runActionList_4330() {
	window.obj3285_onTap_runningActionsCount = obj3285_onTap_runningActionsCount + 1;
	$("#obj3534").trigger('SCEventRun');
	setTimeout(function() {
		window.obj3285_onTap_runningActionsCount = window.obj3285_onTap_runningActionsCount - 1;
if (window.obj3285_onTap_runningActionsCount == 0) {
	obj3285_onTap_actionGroup1();
}		
	}, 1);
}
...
obj3285_onTap_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3285_onTap_activeActionGroupIndex = -1;
		$("#obj3285").trigger("obj3285_onTap_ended");
...
obj3285_onTap_actionGroup2 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj3285_onTap_activeActionGroupIndex = -1;
		$("#obj3285").trigger("obj3285_onTap_ended");
	...
	window.obj3285_onTap_activeActionGroupIndex = 2;
...
obj3288_onShow_actionGroup0 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3288_onShow_activeActionGroupIndex = -1;
		$("#obj3288").trigger("obj3288_onShow_ended");
		
		return;
	}
	window.obj3288_onShow_activeActionGroupIndex = 0;
...
function show_4336() {
	var element = "#obj3290";
	$(element).removeClass("animated bounce flash pulse rubberBand shake headShake swing tada wobble jello bounceIn bounceInDown bounceInLeft bounceInRight bounceInUp bounceOut bounceOutDown bounceOutLeft bounceOutRight bounceOutUp fadeIn fadeInDown fadeInDownBig fadeInLeft fadeInLeftBig fadeInRight fadeInRightBig fadeInUp fadeInUpBig fadeOut fadeOutDown fadeOutDownBig fadeOutLeft fadeOutLeftBig fadeOutRight fadeOutRightBig fadeOutUp fadeOutUpBig flipInX flipInY flipOutX flipOutY lightSpeedIn lightSpeedOut rotateIn rotateInDownLeft rotateInDownRight rotateInUpLeft rotateInUpRight rotateOut rotateOutDownLeft rotateOutDownRight rotateOutUpLeft rotateOutUpRight hinge jackInTheBox rollIn rollOut zoomIn zoomInDown zoomInLeft zoomInRight zoomInUp zoomOut zoomOutDown zoomOutLeft zoomOutRight zoomOutUp slideInDown slideInLeft slideInRight slideInUp slideOutDown slideOutLeft slideOutRight slideOutUp heartBeat");
	window.obj3288_onShow_runningActionsCount = obj3288_onShow_runningActionsCount + 1;
	...
	if ($(element).css("display") == "block" || animationType == "" || animationDurationMs == 0) {
		setTimeout(function() {
			$(element).css("display", "block");
			window.obj3288_onShow_runningActionsCount = window.obj3288_onShow_runningActionsCount - 1;
if (window.obj3288_onShow_runningActionsCount == 0) {
	obj3288_onShow_actionGroup1();
}
			$(element).trigger('SCEventShow');
		}, 1);
		return;
...
obj3288_onShow_actionGroup1 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3288_onShow_activeActionGroupIndex = -1;
		$("#obj3288").trigger("obj3288_onShow_ended");
...
obj3288_onShow_actionGroup2 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3288_onShow_activeActionGroupIndex = -1;
		$("#obj3288").trigger("obj3288_onShow_ended");
	...
	window.obj3288_onShow_activeActionGroupIndex = 2;
...
//	action: Switch Text
switchText_4680();
function switchText_4680() {
	window.obj3288_onShow_runningActionsCount = obj3288_onShow_runningActionsCount + 1;
	var fadeTime = 0;
	var newHtml = "<p>Help me find it!</p>";
	var switchTextFunction = function () {
		$("#obj3290").html(newHtml);
		setTimeout(function () {
			window.obj3288_onShow_runningActionsCount = window.obj3288_onShow_runningActionsCount - 1;
if (window.obj3288_onShow_runningActionsCount == 0) {
	obj3288_onShow_actionGroup3();
}
		}, 1);
	};
	if (fadeTime > 0) {
		var oldHtmlWrapped = "<div id=\"obj3290_old\" style=\"position:absolute; top:0px; width:100%;\">" + $("#obj3290").html() + "</div>";
		var newHtmlWrapped = "<div id=\"obj3290_new\" style=\"position:absolute; top:0px; width:100%; display:none;\">" + newHtml + "</div>";
		$("#obj3290").html(oldHtmlWrapped + newHtmlWrapped);
		$("#obj3290_old").fadeOut(fadeTime);
		$("#obj3290_new").fadeIn(fadeTime, switchTextFunction);
	} else {
		switchTextFunction();
	}
}
...
obj3288_onShow_actionGroup3 = function(){
	isLastActionGroup = false;
	if (isLastActionGroup) {
		window.obj3288_onShow_activeActionGroupIndex = -1;
		$("#obj3288").trigger("obj3288_onShow_ended");
	...
	window.obj3288_onShow_activeActionGroupIndex = 3;
...
obj3288_onShow_actionGroup4 = function(){
	isLastActionGroup = true;
	if (isLastActionGroup) {
		window.obj3288_onShow_activeActionGroupIndex = -1;
		$("#obj3288").trigger("obj3288_onShow_ended");
	...
	window.obj3288_onShow_activeActionGroupIndex = 4;
...
/*
 *
 *   obj3285: Event Touch Down
 *
 */
 
$("#obj3285").bind(PubCoder.Events.Tap, function(event) {
	event.preventDefault();	
	if (window.obj3285_onTap_activeActionGroupIndex != -1) return;
var obj3285_onTap_runningActionsCount = 0;
var obj3285_onTap_loopCount = 0;
obj3285_onTap_actionGroup0();
});
...
$("#obj3288").bind('SCEventShow', function(event) {
	if (window.obj3288_onShow_activeActionGroupIndex != -1) return;
var obj3288_onShow_runningActionsCount = 0;
var obj3288_onShow_loopCount = 0;
obj3288_onShow_actionGroup0();
});
